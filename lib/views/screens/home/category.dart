...
import 'package:jebby/views/screens/home/sub_category.dart';
  ...
  Future<int> _getProductCount(String subcategoryId) {
    return _productCountFutures.putIfAbsent(
      ...
      () async {
        try {
          final result =
              await ApiRepository.shared.fetchProductsBySubCategoryId(
            subcategoryId,
          );
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 600,
                  child: FutureBuilder(
                    future: ApiRepository.shared.fetchSubCategoryList(
                      widget.id.toString(),
                    ),
                    builder: (
                      context,
