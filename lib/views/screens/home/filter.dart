...
import 'package:jebby/views/screens/home/filtered_data.dart';
        ...
        builder:
            (context) => Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  IconButton(
                    icon: Icon(Icons.my_location, color: AppColors.darkBlue),
                    onPressed: () {
                      final lat = _mapCenterLatitude;
                      final lng = _mapCenterLongitude;
        ...
        if (this.mounted)
          {
            if (List.data!.length == 0)
            ...
            else
              {
                ...
                Get.to(() => FilteredDataScreen(subCatname: sub_dropdownvalue)),
              },
          },
      },
      (error) => {
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.my_location, color: AppColors.darkBlue, size: 20),
                    SizedBox(width: 8),
                    Switch(
                      value: _showMap,
                      onChanged: (value) {
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.fullscreen, color: AppColors.darkBlue),
                    onPressed: () {
                      _showFullScreenMap();
                    },
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.radar, color: AppColors.darkBlue),
                    SizedBox(width: 8),
                    Text(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.attach_money, color: AppColors.darkBlue),
                    SizedBox(width: 8),
                    Text(
