      ...
      return Theme(
        data: base.copyWith(
          ...
          datePickerTheme: DatePickerThemeData(
            ...
            todayForegroundColor: WidgetStateProperty.all(AppColors.darkBlue),
      ...
      return SafeArea(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.photo_library_outlined, color: AppColors.darkBlue),
              title: Text(
                'Choose from gallery',
                style: GoogleFonts.inter(
                  fontSize: 15,
            ...
            ListTile(
              leading: Icon(Icons.photo_camera_outlined, color: AppColors.darkBlue),
              title: Text(
                'Take a photo',
                style: GoogleFonts.inter(
                  fontSize: 15,
